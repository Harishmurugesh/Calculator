...
import static com.example.calc2.Fragment2.answer;
import static com.example.calc2.Fragment2.question;
import static com.example.calc2.MainActivity.finalOutput;
import static com.example.calc2.MainActivity.input;
import static com.example.calc2.MainActivity.output;
...
public class Fragment1 extends Fragment {
    ...
    TextView n00,n0,npoint,nequal,n1,n2,n3,n4,n5,n6,n7,n8,n9,nplus,nminus,ndivide,nmultiply,npercent,nAC;
    ImageView backSpace;
    ...
    private void getAnswer() {
        ...
        if(input.split("\\+").length==2){
            ...
            try{
                ...
                answer.setText(finalOutput);
                question.setText(finalOutput);
                input = finalOutput + "";

            }catch (Exception e){
                answer.setError(e.getMessage().toString());
            }
        }
